...
describe('viewportYearRange', () => {
  ...
  it('wider viewport covers more years', () => {
    ...
    expect(wide.endYear - wide.startYear).toBeGreaterThan(
      narrow.endYear - narrow.startYear,
    );
  });
});
...
describe('yearToT edge cases', () => {
  ...
  it('is strictly monotonic', () => {
    const years = [-1_000_000_000, -1_000_000, -10_000, -100, 0, 100, 10_000, 1_000_000, 1_000_000_000];
