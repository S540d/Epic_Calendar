...
_Keine offenen Issues aus der letzten Runde — #76 (Mehr Inhalte), #162 (Farblogik), #163 (Länder-/Kultur-Filter) und #171 (Lernsprüche) sind umgesetzt bzw. geschlossen. #226 (Themen-Tags): erster Schritt (kuratiertes Themen-Vokabular + Filter im `FilterSheet`) umgesetzt; mögliche Folgeschritte (eigener Themen-Bereich auf der Startseite, weitere Themen/Events) bewusst nicht Teil dieses Schritts._
