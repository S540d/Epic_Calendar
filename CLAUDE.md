...
- `src/data/` – statische Daten: 7 JSON-Dateien, 564 Events gesamt (europa, asien, afrika, amerika, ozeanien, erdzeitalter, natur-wissenschaft)
...
│   ├── events/                # Statische JSON-Daten: europa (199), asien (90), afrika (66), amerika (70), ozeanien (40), erdzeitalter (31), natur-wissenschaft (68) → 564 Events gesamt
│   └── ...
├── timeline/
