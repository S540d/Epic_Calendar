...
- **Griechische Philosophen mit Einflusslinien:** 6 neue `herrscher`-Events in `europa.json` — Sokrates, Platon, Aristoteles, Pyrrhon von Elis, Epikur, Zenon von Kition — verbunden über eine gemeinsame `lineageId` (`griechische-philosophie`), sodass eine durchgehende Verbindungslinie ihre Abfolge und wechselseitigen Bezüge (Sokrates → Platon als Lehrer-Schüler-Kette; Aristoteles kritisiert Platons Ideenlehre; Pyrrhon und Epikur setzen sich kritisch von Platon bzw. Aristoteles ab; Zenons Stoa übernimmt Logos-Konzept und Tugendideal aus der platonischen Tradition) im Zeitstrahl sichtbar macht. Daten und Einflussbeziehungen orientieren sich am bereits ausgearbeiteten Denkschulen-Graphen in [s540d/philosophen](https://github.com/s540d/philosophen).
